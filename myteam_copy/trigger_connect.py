...
# --- Jessie RAG search ---
from knowledgebase import rag_search
...
rag_search_tool = agents.function_tool(async_knowledgebase.rag_search)
...
# ------------------------------------------------------------
Use `rag_search` when the user asks conceptual, policy, definition, or narrative questions 
not answerable from numeric dataset fields.
...
demo = gr.ChatInterface(
    ...
    examples=[
        ...
        "What are the segments and their balances for this month?",
        "As the Country Manager for Peru, how many active clients made at least one transaction last month?",
        "As a General Manager looking at all countries, what are the top 3 insights for last month?",
    ],
)
